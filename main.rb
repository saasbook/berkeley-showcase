...
session = GoogleDrive.saved_session(path_or_config = nil, proxy = nil, client_id = "388409492168-tjsug3d5bfbb3fuijibdrnqplimp2cen.apps.googleusercontent.com", client_secret = ENV["GOOGLE_CLIENT_SECRET"])
